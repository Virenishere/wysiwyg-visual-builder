              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {parent.size.height}px • {parent.rnds?.length || 0} boxes
                  </p>
                </div>
              </div>
                    ...
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, #3b82f6 0%, #3b82f6 ${
                          ((parent.size.height - 100) / (windowHeight - 100)) * 100
                        }%, #e5e7eb ${((parent.size.height - 100) / (windowHeight - 100)) * 100}%, #e5e7eb 100%)`,
                      }}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        type="color"
                        value={
                          parent.size.background.startsWith("linear") || parent.size.background.startsWith("radial")
                            ? "#3b82f6"
