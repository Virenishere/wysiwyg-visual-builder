...
const testimonialPageTemplate = {
  ...
  thumbnail: 'https://images.unsplash.com/photo-1556741533-6e6a62bd8b49?w=200&h=150&fit=crop',
  parents: [
    {
      size: { height: 500, background: "linear-gradient(135deg, #fd79a8 0%, #e84393 100%)" },
      rnds: [
        {
          width: 500,
          height: 150,
          ...
          elements: [
            {
              ...
              width: 280,
              height: 100,
              content: '<p style="font-style: italic; line-height: 1.6; font-size: 16px;">"Exceptional service and outstanding results. They exceeded all our expectations and delivered exactly what we needed."</p>',
              fontSize: 16,
              fontFamily: 'Arial, sans-serif',
              color: '#333333',
          ...
          elements: [
            {
              ...
              width: 280,
              height: 100,
              content: '<p style="font-style: italic; line-height: 1.6; font-size: 16px;">"Professional team with great communication. The project was completed on time and within budget."</p>',
              fontSize: 16,
              fontFamily: 'Arial, sans-serif',
              color: '#333333',
              backgroundColor: '#f8f9fa',
...
const productsPageTemplate = {
  ...
  parents: [
    {
      size: { height: 450, background: "linear-gradient(135deg, #00cec9 0%, #55a3ff 100%)" },
      rnds: [
        {
          width: 500,
          height: 150,
        ...
        // Product 1
        {
          ...
          elements: [
            ...
            },
            {
              ...
              width: 230,
              height: 50,
              content: '<p style="line-height: 1.4;">High-quality wireless headphones with noise cancellation and premium sound.</p>',
              fontSize: 12,
              fontFamily: 'Arial, sans-serif',
              color: '#666666',
              backgroundColor: 'transparent',
        ...
        // Product 2
        {
          ...
          elements: [
            ...
            },
            {
              ...
              width: 230,
              height: 50,
              content: '<p style="line-height: 1.4;">Advanced smartwatch with health tracking and long battery life.</p>',
              fontSize: 12,
              fontFamily: 'Arial, sans-serif',
              color: '#666666',
              backgroundColor: 'transparent',
